...
// produces is checked during handler mapping, so a client that accepts no JSON gets 406 before any mutation runs (TASK-017).
@RestController
@RequestMapping("/api/v1/equipment-requests", produces = [MediaType.APPLICATION_JSON_VALUE])
