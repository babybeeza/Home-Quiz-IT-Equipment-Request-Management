...
**สถานะ:** [TASK-010](docs/delivery/tasks/TASK-010-list-row-actions.md) list-row actions / P1 AT-33 ผ่าน automated acceptance; ผู้ใช้อนุมัติ Design/Implement/Verify และ Delivery เมื่อ 2026-09-26 สำหรับ GitHub `main` revision `77b56241a9eef817c62e34d4e949bfc6ecfdc9f7` ([approval record](docs/governance/approvals.md)). Application revision `bb888a9` ผ่าน clean-checkout checks และ smoke ([evidence](docs/quality/evidence/TASK-013.md)); manual P2 AT-44/AT-46 และ rollback/data restore ยัง NOT RUN. [TASK-011](docs/delivery/tasks/TASK-011-assignment-token.md): source owner ยืนยันว่า token ถูก revoke แล้วและ URL เดิมคืน HTTP 403 อีกครั้ง; release owner ยอมรับว่า URL text ยังอยู่ใน Git history.
