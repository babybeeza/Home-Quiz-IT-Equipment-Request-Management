...
| A-08 | Git repository handoff location/access และ immutable revision สำหรับ REQ-13 | Open: publish branch `codex/req13-candidate-20260926` ไปยัง GitHub แล้ว และ independent clone โดยไม่ใช้ stored credentials ผ่าน ([evidence](../quality/evidence/TASK-013.md)); release owner ยังต้องยอมรับ handoff method กับ final immutable commit และยังไม่มี reviewer sign-off; โจทย์ไม่กำหนด Git host หรือ public visibility | [REQ-13 Discover](req-13-discovery.md), [TASK-013](../delivery/tasks/TASK-013-req13-release-handoff.md) |
