...
| A-08 | Git repository handoff location/access และ immutable revision สำหรับ REQ-13 | Open: มี GitHub `origin` อยู่แล้ว แต่ release owner ยังต้องยืนยันว่าจะใช้ remote นี้, reviewer เข้าถึงอย่างไร และ revision ใดก่อน Delivery gate; โจทย์ไม่กำหนด Git host หรือ public visibility | [REQ-13 Discover](req-13-discovery.md), [TASK-013](../delivery/tasks/TASK-013-req13-release-handoff.md) |
