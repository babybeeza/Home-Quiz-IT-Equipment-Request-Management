...
| A-09 | แหล่งสีและขอบเขตธีม Spark Deck สำหรับ REQ-14 | Palette resolved 2026-09-26 จากตาราง hex 12 สีที่ผู้ใช้ให้โดยตรง; scope จากคำขอคือสี UI เท่านั้น. Design ต้องเสนอ semantic mapping และคู่สีที่ contrast ผ่านเกณฑ์ก่อน Implement; ยังไม่ได้ตรวจไฟล์ deck จริงหรืออนุมัติ design | [REQ-14 Discover](req-14-theme-discovery.md) |
