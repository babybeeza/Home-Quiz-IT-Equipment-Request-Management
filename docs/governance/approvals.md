...
| Design | Technical owner | architecture, ADRs, contract, data/test plan | Approved through TASK-004 |
| Implement | Code reviewer | code diff, implementation tests and task evidence | Approved through TASK-004 |
